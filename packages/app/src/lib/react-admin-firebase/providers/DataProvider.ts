...
import { MakeFirestoreLogger, getAbsolutePath, log, logError, logger, retrieveStatusCode } from '../misc';
...
export function DataProvider(firebaseConfig: {}, optionsInput?: RAFirebaseOptions): IDataProvider {
    ...
    const newProviderApi: IDataProvider = {
        ...
        getList<RecordType extends ra.RaRecord = ra.RaRecord>(resource: string, params: ra.GetListParams): Promise<ra.GetListResult<RecordType>> {
